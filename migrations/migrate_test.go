...
func TestEmbeddedMigrationNamesAreSorted(t *testing.T) {
	...
	want := []string{
		...
		"0008_responsibility_handover.sql",
		"0009_responsibility_outbox_delivery.sql",
		"0010_estimator_results.sql",
		"0011_audit_ledger.sql",
		"0012_estimator_audit_binding.sql",
		"0013_handover_audit_binding.sql",
		"0014_evaluation_audit_binding.sql",
		"0015_evidence_bundle_audit.sql",
	}
